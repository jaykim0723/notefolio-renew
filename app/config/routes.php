...
$route['(:any)/(gallery|collection|about|statistics|setting|following|followers)/(:num)'] = "profile/$2/$1/$3"; // tabs list
$route['(:any)/(gallery|collection|about|statistics|setting|following|followers)/(:any)'] = "$2/$3/$1"; // maxzidell/gallery/upload -> gallery/upload/maxzidell
$route['(:any)/(gallery|collection|about|statistics|setting|following|followers)'] = "profile/$2/$1"; // tabs
