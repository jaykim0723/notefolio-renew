...
$route['(auth|auth_other|profile|upload|invite|info|main|feed|referrer|invite2|featured|active_user|alarm|fbauth)'] = "$1"; // auth결과 메시지를 출력한다.
...
$route['(gallery|profile|auth|auth_other|acp|comment|upload|info|main|feed|factive_user|alarm|fbauth)/(:any)'] = "$1/$2";
$route['(gallery|profile|auth|auth_other|acp|comment|upload|info|main|feed|factive_user|alarm|fbauth)'] = "$1";
