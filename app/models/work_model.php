...
class work_model extends CI_Model {
    ...
    function get_list_prep($params){
        ...
        if(!empty($params->q)){
            $this->db->where('works.title like \'%'.$this->db->escape_str($params->q).'%\' or works.keywords like \'%'.$this->db->escape_str($params->q).'%\' or or users.username like \'%'.$this->db->escape_str($params->q).'%\' or users.realname like \'%'.$this->db->escape_str($params->q).'%\'  )', NULL, FALSE);
        }
