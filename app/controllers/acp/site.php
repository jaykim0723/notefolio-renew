        ...
        switch($mode) {
            case "list":
                ...
                if(isset($args['search']['only_outside'])){
                    ...
                    $only_outside = true;
                    $args['search']['(to_access not like "/feed/check_unread" remote_addr != "127.0.0.1" and referer is not null and referer not like "%.notefolio.net%" and referer not like "%.localhost%")'] = null;
