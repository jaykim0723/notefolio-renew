...
$lang['required'] 			= "%s 을(를) 입력해주세요.";
$lang['isset']				= "%s 필드는 반드시 필요한 값입니다.";
$lang['valid_email']		= "%s 는 올바른 이메일 형식이 아닙니다.";
$lang['valid_emails'] 		= "%s 는 올바른 이메일 형식이 아닙니다.";
$lang['valid_url'] 			= "%s 필드는 유효한 URL을 포함해야 합니다.";
$lang['valid_ip'] 			= "%s 필드는 유효한 IP를 포함해야 합니다.";
$lang['min_length']			= "%s 는 %s 자 이상 입력해주세요.";
...
$lang['matches']			= "%s 이(가) %s 와 같지 않습니다.";
$lang['is_natural']			= "%s 필드는 반드시 0과 자연수만 포함할 수 있습니다.";
$lang['is_natural_no_zero']	= "%s 필드는 반드시 0을 초과하는 자연수만 포함할 수 있습니다.";
$lang['regex_match']			= "%s 필드는 올바른 형식이 아닙니다.";
$lang['is_unique'] 				= "%s 필드의 값은 유일해야 합니다.";
$lang['decimal']				= "%s 필드는 정수를 입력해야 합니다.";
$lang['less_than']				= "%s 필드는 %s보다 작아야 합니다.";
$lang['less_than_equal_to']		= "%s 필드는 %s보다 작거나 같아야 합니다.";
$lang['greater_than']			= "%s 필드는 %s보다 커야 합니다.";
$lang['greater_than_equal_to']	= "%s 필드는 %s보다 크거나 같아야 합니다..";
