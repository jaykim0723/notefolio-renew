...
//		console.log('site.js > snsUtil > kakaotalk');
		...
		this.newPop('storylink://posting?urlinfo='+workInfo.url+'&post='+workInfo.summary+'&type=link&appid=notefolio.net&appname=notefolio&appver=2.0&apiver=1.0', 620, 310);
	},
