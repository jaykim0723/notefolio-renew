...
//		console.log('site.js > snsUtil > kakaotalk');
		...
		this.newPop('storylink://posting?post='+workInfo.title+' '+workInfo.summary+' '+workInfo.url+'&type=link&appid=notefolio.net&appname=notefolio&appver=2.0&apiver=1.0', 620, 310);
	},
