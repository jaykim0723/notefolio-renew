...
//		console.log('site.js > snsUtil > kakaotalk');
		...
		this.newPop('kakaolink://sendurl?url='+workInfo.url+'&msg='+workInfo.summary+'&type=link&appid=net.notefolio&appname=notefolio', 620, 310);
	},
...
//		console.log('site.js > snsUtil > kakaotalk');
		...
		this.newPop('storylink://posting?post='+workInfo.title+'%3B%20%0A'+workInfo.summary+'%3B%20%0A'+workInfo.url+'&type=link&appid=notefolio.net&appname=notefolio&appver=2.0&apiver=1.0', 620, 310);
	},
